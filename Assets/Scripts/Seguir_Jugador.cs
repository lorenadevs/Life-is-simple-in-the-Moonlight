...
public class Seguir_Jugador : StateMachineBehaviour
{
    ...
    private BossComportamiento boss;
    ...
    override public void OnStateEnter(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        boss = animator.GetComponent<BossComportamiento>();
        rb2D = boss.rb2D;
    ...
    override public void OnStateUpdate(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
       ...
       boss.Girar(jugador.position);
       tiempoSeguir += Time.deltaTime;
        if(tiempoSeguir >= tiempoBase){
            tiempoSeguir = 0;
